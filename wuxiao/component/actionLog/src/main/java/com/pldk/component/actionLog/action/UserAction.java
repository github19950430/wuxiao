package com.pldk.component.actionLog.action;
...
import com.pldk.component.actionLog.action.model.LoginMethod;
...
public class UserAction extends ActionMap {
    ...
    public static final String EXPERT_SAVE = "expert_save";
    ...
    public void init() {
        ...
        // 保存专家行为
        putMethod(EXPERT_SAVE, new BusinessMethod("专家管理","expertrSave"));
        // 修改用户密码行为
    ...
    // 保存用户行为方法
    public void expertrSave(ResetLog resetLog){
    	resetLog.getActionLog().setMessage("专家成功：${username}");
    	SaveAction.defaultMethod(resetLog);
    }
