...
import com.pldk.component.actionLog.action.base.ResetLog;
import com.pldk.component.actionLog.action.model.ActionModel;
import com.pldk.component.actionLog.action.model.BusinessMethod;
import com.pldk.component.actionLog.action.model.BusinessType;
import com.pldk.component.shiro.ShiroUtil;
import com.pldk.modules.system.domain.ActionLog;
import com.pldk.modules.system.service.ActionLogService;
...
public class ActionLogAop {
    ...
    @Pointcut("@annotation(com.pldk.component.actionLog.annotation.ActionLog)")
    ...
    public Object recordLog(ProceedingJoinPoint point) throws Throwable {
        ...
        com.pldk.component.actionLog.annotation.ActionLog anno =
                targetMethod.getAnnotation(com.pldk.component.actionLog.annotation.ActionLog.class);
        // 获取name值
        ...
        if(ShiroUtil.getSubject() != null){
            actionLog.setOperName(ShiroUtil.getSubject().getRealname());
        }
