...
import com.pldk.admin.system.validator.DeptValid;
...
import com.pldk.component.shiro.UserAuthFilter;
...
public class DeptController {
    ...
    public ResultVo list(Dept dept) {
       ...
       ExampleMatcher matcher = ExampleMatcher.matching().
        ...
        //List<Dept> list =deptService.getListByPid(1L, 0L);
     ...
     * 组织数据列表
     */
    @GetMapping("/currentLevelList")
    @ResponseBody
    public ResultVo currentLevelList(Dept dept) {
        ...
        List<Dept> list = deptService.getListByPidLikeOk(dept.getId());
        //List<Dept> list =deptService.getListByPid(1L, 0L);
        return ResultVoUtil.success(list);
    }
    ...
    @RequiresPermissions({"system:dept:add", "system:dept:edit"})
    @ResponseBody
    @ActionLog(name = "组织管理", message = "组织：${title}", action = SaveAction.class)
    ...
    @ResponseBody
    @ActionLog(name = "组织状态", action = StatusAction.class)
