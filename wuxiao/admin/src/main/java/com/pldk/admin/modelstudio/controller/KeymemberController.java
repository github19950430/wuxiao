...
import com.pldk.admin.modelstudio.validator.KeymemberValid;
 ...
 */
@Controller
@RequestMapping("/modelstudio/keymember")
public class KeymemberController {
    ...
    @RequiresPermissions("modelstudio:keymember:status")
    @ResponseBody
    public ResultVo status(
        ...
        if (keymemberService.updateStatus(statusEnum, ids)) {
