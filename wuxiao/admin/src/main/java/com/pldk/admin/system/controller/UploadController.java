...
import com.pldk.component.fileUpload.enums.UploadResultEnum;
...
public class UploadController {
     ...
     * 根据文件id查看文件信息
     */
    @PostMapping("/upload/findById")
    @ResponseBody
    public ResultVo findFileById(@RequestParam("uploadFile") long id) {
    	Upload upload = uploadService.getById(id);
    	if (upload != null) {
			return ResultVoUtil.success(upload);
		} else {
			return ResultVoUtil.error("无此文件信息");
		}
    }
